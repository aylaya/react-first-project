  ...
  return (
    <footer className="footer">
      <div className="footer-content">
        <img src='https://first-react-project-gilt.vercel.app/assets/footerIcon-PUYEE3Zb.svg' alt='logo' height={50} width={50}/> 
        ...
        <h3>Want to recieve our awesome stories?</h3>
          ...
          <div className="footer-links">
            <ul>
              <li>Email: </li>
              <li><a href="mailto:info@test.com">info@ayla.com</a></li>
